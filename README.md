<!--
**Romasa102/Romasa102** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
- **Experts in Information Science Program (NII/JST STELLA)** (2024--2025)
  - Selected for national high-school informatics research.
  - Conducted *Guitar Audio Classification* research using ML-based methods for signal classification.
  
- **VNET (Project & Business Intern)** (2024)
  - Market research for Japan entry; assisted in investment evaluation and English-Japanese translation.
...
- **Canadian Senior Mathematics Contests** — Student Honor Roll (2025)
- **Japanese Olympiad in Informatics** — Final Round B Rank (2024)
